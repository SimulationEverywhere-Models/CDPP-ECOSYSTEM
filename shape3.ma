...
rule : { 4 } 100 { (0,0) = 0 and ((1,1) = 3 or (1,1) = 4) and (#macro(XseedPos) - cellPos(0) ) > 7 and (#macro(XseedPos) - cellPos(0) ) < 12 and ( cellPos(1) = (#macro(branch1) + cellPos(0) ) ) }
rule : { 4 } 100 { (0,0) = 0 and ( cellPos(1) = #macro(YseedPos) ) and (#macro(XseedPos) - cellPos(0) ) < 12 and (#macro(XseedPos) - cellPos(0) ) > 7 and ((1,0) = 3 or (1,0) = 4) }
rule : { 5 } 100 { (0,0) = 0 and ((1,-1) = 4 or (1,-1) = 5) and (#macro(XseedPos) - cellPos(0) ) > 11 and (#macro(XseedPos) - cellPos(0) ) < 16 and ( cellPos(1) = (#macro(branch2) + ( 20 - cellPos(0) ) ) ) }
rule : { 5 } 100 { (0,0) = 0 and ( cellPos(1) = #macro(YseedPos) ) and (#macro(XseedPos) - cellPos(0) ) < 16 and (#macro(XseedPos) - cellPos(0) ) > 11 and ((1,0) = 4 or (1,0) = 5) }
rule : {(0,0)} 100 {t}
